...
def main(host, port):
    ...
    try:
        ...
        skill = AgentSkill(
            id="teacher",
            name="Teacher",
            description="Teaches new topics through summarization and presentation.",
            tags=["teacher", "learn", "teach"],
            examples=["Summarize the following research."],
        )
        agent_card = AgentCard(
            name="Teacher Agent",
            description="Helps teach new concepts.",
