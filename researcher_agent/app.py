...
async def main():
    ...
    with gr.Blocks(theme=gr.themes.Ocean(), title="A2A Researcher Agent") as demo:
        gr.ChatInterface(
            get_response_from_agent,
            title="A2A Researcher Agent",  # Title can be handled by Markdown above
            description="This assistant can help you learn something new!",
        )
